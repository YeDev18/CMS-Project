...
const Tonages = () => {
  ...
  // const getDataTonnes = async () => {
  //   await url
  //     .get('api/calcul-difference-tonnage/')
  //     .then(res => res.data)
  //     .then(data => {
  //       setTonnes(data), console.log(tonnes);
  //     })
    ...
    <div className="w-full h-full relative flex flex-col gap-6 ">
      ...
      <div className="w-full h-full overflow-x-auto  pr-2 relative">
        <table className="w-full">
          <thead>
            <tr className="gridArray8  w-screen rounded-md shadow-sm shadow-testColors1 bg-slate-50 sticky top-0">
